...
import {INewSavedLocationInstance, IRemoveSavedLocationInstance, IUserDataRequest} from "../contracts/entities";
...
export async function removeLocationInstance(req: IRemoveSavedLocationInstance, res: express.Response) {
    ...
    const deletionResult = await mongo.SavedLocationMongoModel.remove({'_id': locationId, 'uid': req.authContext._id});
