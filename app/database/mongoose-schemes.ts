...
export const CountryOutlineModel = mongoose.model<ICountryOutlineDocument>('countryoutlines', mongoCountryOutlinesSchema);
...
export const TtlTenMinStrokeMongoModel = mongoose.model<IStrokeDocument>('ttlTenMinStrokes', mongoStrokeSchemaTtlTenMin);
export const TtlOneHourStrokeMongoModel = mongoose.model<IStrokeDocument>('ttlOneHourStrokes', mongoStrokeSchemaTtlOneHour);
...
export const LocationLogMongoModel = mongoose.model<IDeviceLocationLogDocument>('locationData', mongoLocation);
export const LocationRecentMongoModel = mongoose.model<IDeviceLocationRecentDocument>('locationDataRecent', mongoLocationRecent);
