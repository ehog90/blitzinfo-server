...
export class LocationUpdaterService implements ILocationUpdater {
    ...
    private async insertLastLocationToDatabaseAndUpdate(updater: LocationUpdateSource,
        ...
        try {
            ...
            if (!existingData) {
                return Promise.resolve(LocationUpdaterService.saveRecentToDatabase(updater, deviceData, logResult));
            } else {
...
LocationUpdaterService(loggerInstance, grg.googleReverseGeoCoder, huRegReverseGeocoder);
